...
Thesis work to be submitted to the [faculty](https://www.swarthmore.edu/psychology/faculty-staff) of the [Department of Psychology](https://www.swarthmore.edu/psychology) at [Swarthmore College](swarthmore.edu) in April 2019 in partial fulfillment for the degree of Bachelor of Arts.
...
d |n
d |n
name of file that lists data files |../data/robodoc/keep.lst
exceptions     |n
count file     |../data/scripter/output_from_scripter.cnt

4. The next step should be "Which analysis?" If this is true, continue to the next step. If not, something probably went wrong.
...
* This repo is no longer actively being maintained as of March 2019

# Acknowledgements
Thanks to Professors [Dan Grodner](https://www.swarthmore.edu/psychology/faculty-staff) and [Nathan Sanders](http://sanders.phonologist.org) for enormous guidance and for setting up the experiment; to Drs. [Mara Breen](https://www.mtholyoke.edu/~mbreen/) and [Charles Clifton](http://www.umass.edu/pbs/people/charles-clifton) for providing the stimuli and the research on which this study was based; to Drs. [Charles Clifton](http://www.umass.edu/pbs/people/charles-clifton), [Adrian Staub](https://www.umass.edu/pbs/people/adrian-staub), [Andrew Cohen](https://www.umass.edu/pbs/people/andrew-cohen), [Jesse Harris](https://linguistics.ucla.edu/person/jesse-harris/), and [colleagues](http://blogs.umass.edu/eyelab/people/) for creating and maintaining the [eyetracking analysis software](http://blogs.umass.edu/eyelab/software/); to the alumni and current students practicing research in the [Swarthmore Psycholinguistics Lab](https://www.swarthmore.edu/psychology/labs); and to the undergraduate students at Swarthmore College who participated in the study.
...
# TODO
* finish this readme
* readme for the rest of the drive
* re-preregistration
* gather rest of the analysis files
* check that the analyses is working
* still writing the actual paper
* can we please do part 2
