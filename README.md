...
| File of item X subject combinations | `../data/eyedry/originals/firstPassIXS` | We will base our analysis on this file. |
...
| Subject by subject file, one condition per line (not systat) | `../data/eyedry/originals/firstPassSXS` | We won't base our analysis on this file, but we might as well save it. |
| Subject by subject file, formatted for Systat | [press return] | We don't want this file. |
| Item by item file, one condition per line (not systat) | `../data/eyedry/originals/firstPassIXI` | We won't base our analysis on this file, but we might as well save it. |
...
| File of item X subject combinations | `../data/eyedry/originals/goPastIXS` | We will base our analysis on this file. |
| Do you want ALL trials written, or just trials with Observations? | a | |
| Do you want Wide output (all regions in one row) or Narrow (one row per region)? | w | |
| Subject by subject file, one condition per line (not systat) | `../data/eyedry/originals/goPastSXS` | We won't base our analysis on this file, but we might as well save it. |
| Subject by subject file, formatted for Systat | [press return] | We don't want this file. |
| Item by item file, one condition per line (not systat) | `../data/eyedry/originals/goPastIXI` | We won't base our analysis on this file, but we might as well save it.|
| Item by item file, formatted for Systat | [press return] | We don't want this file. |
| Do you want information about long and short times printed? | n | WARNING: "y" is a possible source of segfault. |
| Do you want a typeout of the item-by-item data? | n | WARNING: "y" is a possible source of segfault. |
...
| Conditionalize on position of last fixation before each region? | n | |
| File of item X subject combinations | `../data/eyedry/originals/probFixationIXS` | We will base our analysis on this file. |
| Do you want ALL trials written, or just trials with Observations? | a | |
| Do you want Wide output (all regions in one row) or Narrow (one row per region)? | w | |
| Subject by subject file, one condition per line (not systat) | `../data/eyedry/originals/probFixationSXS` | We won't base our analysis on this file, but we might as well save it. |
| Subject by subject file, formatted for Systat | [press return] | We don't want this file. |
| Item by item file, one condition per line (not systat) | [`../data/eyedry/originals/probFixationIXI` | We won't base our analysis on this file, but we might as well save it. |
| Item by item file, formatted for Systat | [press return] | We don't want this file. |
| Do you want information about long and short times printed? | n | WARNING: "y" is a possible source of segfault. |
| Do you want a typeout of the item-by-item data? | n | WARNING: "y" is a possible source of segfault. |
...
| RAW times, MS/char, or DEVIATION from regression | r | |
| Conditionalize on position of last fixation before each region? | n | |
| File of item X subject combinations | `../data/eyedry/originals/probRegressionIXS` | We will base our analysis on this file. |
| Do you want ALL trials written, or just trials with Observations? | a | |
| Do you want Wide output (all regions in one row) or Narrow (one row per region)? | w | |
| Subject by subject file, one condition per line (not systat) | `../data/eyedry/originals/probRegressionSXS` | We won't base our analysis on this file, but we might as well save it. |
| Subject by subject file, formatted for Systat | [press return] | We don't want this file. |
| Item by item file, one condition per line (not systat) | `../data/eyedry/originals/probRegressionIXI` | We won't base our analysis on this file, but we might as well save it. |
| Item by item file, formatted for Systat | [press return] | We don't want this file. |
| Do you want information about long and short times printed? | n | WARNING: "y" is a possible source of segfault. |
| Do you want a typeout of the item-by-item data? | n | WARNING: "y" is a possible source of segfault. |
...
| RAW times, MS/char, or DEVIATION from regression | r | |
| Conditionalize on position of last fixation before each region? | n | |
| File of item X subject combinations | `../data/eyedry/originals/firstFixationReg3IXS` | We will base our analysis on this file. |
| Do you want ALL trials written, or just trials with Observations? | a | |
| Do you want Wide output (all regions in one row) or Narrow (one row per region)? | w | |
| Subject by subject file, one condition per line (not systat) | `../data/eyedry/originals/firstFixationReg3SXS` | We won't base our analysis on this file, but we might as well save it. |
| Subject by subject file, formatted for Systat | [press return] | We don't want this file |
| Item by item file, one condition per line (not systat) | `../data/eyedry/originals/firstFixationReg3IXI` | We won't base our analysis on this file, but we might as well save it. |
| Item by item file, formatted for Systat | [press return] | We don't want this file |
| Do you want information about long and short times printed? | n | WARNING: "y" is a possible source of segfault. |
| Do you want a typeout of the item-by-item data? | n | WARNING: "y" is a possible source of segfault. |
...
* The subject numbers (second column) in each of the IXS measures files (e.g. `firstPassIXS`) respectively correspond to participants in the `data/robodoc/keep.lst` file.
