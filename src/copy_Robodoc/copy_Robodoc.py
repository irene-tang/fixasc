...
# 4/28/16: eliminated patch line 588 which was intended to deal with extra space after \n. Didn't work with long line 1 and multiple lines.
# 4/28/16: added patch line 452 to eliminate trailing space after \n
...
# check for a trailing space after \n in script, zap it if it exists
			if YPOS[-1] > YPOS[-2]:
				YPOS = YPOS[:-2]
				XPOS = XPOS[:-2]
...
# BUT IT DIDN'T WORK WITH MULTIPLE LINES WHERE LINE 1 WAS LONGER THAN LINE 2.
