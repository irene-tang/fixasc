...
To compile using gcc on a PC, assuming it's on the path:
gcc eyedry.c eyedry -lm
...
7/2/14: increase MAXLINE from 250 to 700 to permit disgustingly long .cnt files, for Jane
...
printf("\ntest open cnt file\n");
conbuff = fopen("../data/scripter/output_from_scripter.cnt","r");
printf("opened it");
...
//		}
		  ...
		  tempcond = readnext(1);
			printf("tempitem and tempcond: %d, %d", tempitem, tempcond);
